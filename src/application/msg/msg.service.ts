...
import {CreateMsgDto} from './dto/index';
...
export class MsgService {
    ...
    async postMsg(): Promise<void> {
        //logic to post a message
    }

    async getMsgByUserId(user_id: string): Promise<void> {
        //logic to get messages by user id
    }
    
    async getUnreadMsgByUserId(user_id: string): Promise<void> {
